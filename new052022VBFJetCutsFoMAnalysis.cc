...
void new052022VBFJetCutsFoMAnalysis(string inputString){
    ...
    if (cutString == "jetPT") {
        cutRangeBottom = jetPTRangeBottom;
        cutStep = jetPTCutStep;
        cutPtr = &jetPTCut;
    }
    if (cutString == "jetEtaDif") {
        cutRangeBottom = jetEtaRangeBottom;
        cutStep = jetEtaCutStep;
        cutPtr = &jetEtaDifCut;
    }
    if (cutString == "jetInvMass") {
        cutRangeBottom = jetInvMassRangeBottom;
        cutStep = jetInvMassCutStep;
        cutPtr = &jetInvMassCut;
    }
