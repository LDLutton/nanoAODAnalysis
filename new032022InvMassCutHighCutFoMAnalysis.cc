...
void new032022InvMassCutHighCutFoMAnalysis(string datasetString){
    // Open the file. Note that the name of your file outside this class
    // will probably NOT be experiment.root.
    std::cout << "start invMassCutHighCut FoM Analysis\n";
    ...
    for (UInt_t k=0; k<fileAr.size(); k++){
        ...
        while (myEventsReader.Next()) {
            ...
            for (UInt_t rangeItr=0; rangeItr<cutAmnt+1; rangeItr++){
                ...
                Z1IsMuon,invMassCutLow,tmpinvMassCutHighCutVal,ptLeadCut,ptTrailingCut,
                ...
                */
                ...
                if (passesCutsBool){
                    if (debug) std::cout << "passesCuts\n";
                    if (debug) std::cout << "evCount " << evCount << " rangeItr " << rangeItr << " passedAsLepBool " << passedAsLepBool << " passedAsSemiLepBool " << passedAsSemiLepBool << "\n";
