...
h_Electron_eta   = TH1F("h_Electron_eta","h_Electron_eta", 200, -5.0, 5.0)
...
h_Electron_phi   = TH1F("h_Electron_phi","h_Electron_phi", 200, -3.5, 3.5)
h_Electron_pt    = TH1F("h_Electron_pt","h_Electron_pt", 200, 0, 200)
...
h_Muon_eta       = TH1F("Muon_eta","Muon_eta", 200, -5.0, 5.0)
h_Muon_mass      = TH1F("h_Muon_mass","h_Muon_mass", 200, 0, 0.15)
h_Muon_phi       = TH1F("h_Muon_phi","h_Muon_phi", 200, -3.5, 3.5)
h_Muon_pt        = TH1F("h_Muon_pt","h_Muon_pt", 200, 0, 200)


h_Jet_eta        = TH1F("h_Jet_eta","h_Jet_eta", 200, -5.0, 5.0)
h_Jet_mass       = TH1F("h_Jet_mass","h_Jet_mass", 200, 0, 200)
h_Jet_phi        = TH1F("h_Jet_phi","h_Jet_phi", 200, -3.5, 3.5)
h_Jet_pt         = TH1F("h_Jet_pt","h_Jet_pt", 250, 0, 500)
...
h_InitialJet_EtaSep     = TH1F("h_InitialJet_EtaSep","h_InitialJet_EtaSep", 200, 0, 10)
h_InitialJet_Eta     = TH1F("h_InitialJet_Eta","h_InitialJet_Eta", 200, -5.0, 5.0)
h_InitialJet_pt    = TH1F("h_InitialJet_pt","h_InitialJet_pt", 250, 0, 500)
h_InitialJetAlt_Eta     = TH1F("h_InitialJetAlt_Eta","h_InitialJetAlt_Eta", 200, -5.0, 5.0)
h_InitialJetAlt_EtaSep     = TH1F("h_InitialJetAlt_EtaSep","h_InitialJetAlt_EtaSep", 200, 0, 10)
h_InitialJetAlt_pt    = TH1F("h_InitialJetAlt_pt","h_InitialJetAlt_pt", 250, 0, 500)
#These for selecting jet pair with inv mass
h_InitialJetAltIM_Eta     = TH1F("h_InitialJetAltIM_Eta","h_InitialJetAltIM_Eta", 200, -5.0, 5.0)
h_InitialJetAltIM_EtaSep     = TH1F("h_InitialJetAltIM_EtaSep","h_InitialJetAltIM_EtaSep", 200, 0, 10)
h_InitialJetAltIM_pt    = TH1F("h_InitialJetAltIM_pt","h_InitialJetAltIM_pt", 250, 0, 500)
#These for selecting jet pair with top jet pt (second jet pt as tiebreaker)
h_InitialJetAltLJ_Eta     = TH1F("h_InitialJetAltLJ_Eta","h_InitialJetAltLJ_Eta", 200, -5.0, 5.0)
h_InitialJetAltLJ_EtaSep     = TH1F("h_InitialJetAltLJ_EtaSep","h_InitialJetAltLJ_EtaSep", 200, 0, 10)
h_InitialJetAltLJ_pt    = TH1F("h_InitialJetAltLJ_pt","h_InitialJetAltLJ_pt", 250, 0, 500)
