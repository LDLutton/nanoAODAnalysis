...
void new032022FourLepInvMassCutFoMAnalysis(string datasetString){
    // Open the file. Note that the name of your file outside this class
    // will probably NOT be experiment.root.
    std::cout << "start FourLepInvMassCut FoM Analysis\n";
    ...
    for (UInt_t rangeItr=0; rangeItr<cutAmnt+1; rangeItr++){
        ...
        cutRangeAr.push_back(fourLepInvMassRangeBottom+(rangeItr*fourLepInvMassCutStep));
    }
    ...
    for (UInt_t k=0; k<fileAr.size(); k++){
        ...
        while (myEventsReader.Next()) {
            ...
            for (UInt_t rangeItr=0; rangeItr<cutAmnt+1; rangeItr++){
                ...
                float tmpFourLepInvMassCutVal = cutRangeAr[rangeItr];
                ...
                eZ2VecPairAr,tmpZ2Ind,Z2IsMuon,tmpTopZ2LeadPt,tmpTopZ2TrailingPt,tmpFourLepInvMassCutVal,optLepInvMassCut,
                mZ2VecPairAr,
                tmpZ1Vec,tmpZ1M,
