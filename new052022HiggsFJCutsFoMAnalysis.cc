...
void new052022HiggsFJCutsFoMAnalysis(string inputString){
    ...
    cutString = elems[1];
    std::cout << "start HiggsFJ " << cutString <<  "Cut FoM Analysis\n";
    ...
    if (cutString == "hFatJetDeepTag") {
        cutRangeBottom = hFatJetDeepTagRangeBottom;
        cutStep = hFatJetDeepTagCutStep;
        cutPtr = &hFatJetDeepTagCut;
    }
    if (cutString == "hFatJetPT") {
        cutRangeBottom = hFatJetPTCutRangeBottom;
        cutStep = hFatJetPTCutStep;
        cutPtr = &hFatJetPTCut;
    }
    if (cutString == "ZPairPlusHInvMass") {
        cutRangeBottom = ZPairPlusHInvMassRangeBottom;
        cutStep = ZPairPlusHInvMassCutStep;
        cutPtr = &ZPairPlusHInvMassCut;
    }
    if (cutString == "ZPairPlusHPt") {
        cutRangeBottom = ZPairPlusHPtRangeBottom;
        cutStep = ZPairPlusHPtCutStep;
        cutPtr = &ZPairPlusHPtCut;
    }
