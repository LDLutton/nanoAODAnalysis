...
void finish02292024BackgroundPreselection(string datasetString, int JECCorInd, bool JECCorUpOrDown,  int RochInd, int JERInd,uint yearInd){
    ...
    if (ttHToBBBackground){
        ...
        for (int i=0; i<arrSize; i++){
            fileAr.push_back("./HLTTrimmedFilteredForAnalysis"+saveName+yearStr+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root");
    ...
    std::string outFileStr = "HLTTrimmedFilteredForAnalysis"+saveName+yearStr+"_WithPreSel_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
