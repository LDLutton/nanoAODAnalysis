...
#"FP" stands for "Full Pass"
FOMZ2OptLepCan.SaveAs("FOMGraph_FP_Z2OptLep_{0}_Vs_{1}_AMSFoM_WithComparZ2OptLepnHist_{2}.png".format(signalName,backgroundName,"{0:02}".format(today.month)+"{0:02}".format(today.day)+"{0:04}".format(today.year)))
