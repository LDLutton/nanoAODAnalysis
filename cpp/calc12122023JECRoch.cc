...
void calc12122023JECRoch(string datasetString, int JECCorInd,  int RochInd){
    ...
    std::string corrTypeAr[27] = {"AbsoluteMPFBias","AbsoluteMPFBias","AbsoluteStat","FlavorQCD","Fragmentation","PileUpDataMC","PileUpPtBB","PileUpPtEC1","PileUpPtEC2","PileUpPtHF","PileUpPtRef","RelativeFSR","RelativeJEREC1","RelativeJEREC2",
    ...
    */
    ...
    JetCorrectionUncertainty jec16EF("../NanoCORE/Tools/jetcorr/data/Summer19UL16APV_RunEF_V7_DATA/Summer19UL16APV_RunEF_V7_DATA_UncertaintySources_AK4PFchs_"+corrTypeAr[JECCorInd]+".txt");
    ...
    //same for AK8 jets
    JetCorrectionUncertainty jec18AAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL18_RunA_V5_DATA/Summer19UL18_RunA_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec18BAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL18_RunB_V5_DATA/Summer19UL18_RunB_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec18CAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL18_RunC_V5_DATA/Summer19UL18_RunC_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec18DAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL18_RunD_V5_DATA/Summer19UL18_RunD_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");

    JetCorrectionUncertainty jec17BAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL17_RunB_V5_DATA/Summer19UL17_RunB_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec17CAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL17_RunC_V5_DATA/Summer19UL17_RunC_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec17DAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL17_RunD_V5_DATA/Summer19UL17_RunD_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec17EAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL17_RunE_V5_DATA/Summer19UL17_RunE_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec17FAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL17_RunF_V5_DATA/Summer19UL17_RunF_V5_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");

    JetCorrectionUncertainty jec16BCDAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL16APV_RunBCD_V7_DATA/Summer19UL16APV_RunBCD_V7_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec16EFAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL16APV_RunEF_V7_DATA/Summer19UL16APV_RunEF_V7_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
    JetCorrectionUncertainty jec16GHAK8("../NanoCORE/Tools/jetcorr/data/Summer19UL16_RunFGH_V7_DATA/Summer19UL16_RunFGH_V7_DATA_UncertaintySources_AK8PFPuppi_"+corrTypeAr[JECCorInd]+".txt");
