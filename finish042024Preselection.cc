...
void finish042024Preselection(string datasetString, int JECCorInd, bool JECCorUpOrDown,  int RochInd, int JERInd){
    ...
    bool CenC2V2MCZZHReweightTrimmed = false;
    bool CenC2V2MCZZH17ReweightTrimmed = false;
    bool CenC2V2MCZZH16ReweightTrimmed = false;
    bool CenC2V2MCZZH16APVReweightTrimmed = false;
    bool CenC2V2MCWZHReweightTrimmed = false;
    bool CenC2V2MCWZH17ReweightTrimmed = false;
    bool CenC2V2MCWZH16ReweightTrimmed = false;
    bool CenC2V2MCWZH16APVReweightTrimmed = false;
    bool CenC2V2MCWWHSSReweightTrimmed = false;
    bool CenC2V2MCWWHSS17ReweightTrimmed = false;
    bool CenC2V2MCWWHSS16ReweightTrimmed = false;
    bool CenC2V2MCWWHSS16APVReweightTrimmed = false;
    bool CenC2V2MCWWHOSReweightTrimmed = false;
    bool CenC2V2MCWWHOS17ReweightTrimmed = false;
    bool CenC2V2MCWWHOS16ReweightTrimmed = false;
    bool CenC2V2MCWWHOS16APVReweightTrimmed = false;
    ...
    if (SDC2V2MCZZHReweightTrimmed){
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisSDC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCZZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCZZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCZZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCZZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCZZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCZZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCZZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisSDC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHSS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisSDC2V2MCWWHOS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisMaC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCZZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCZZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCZZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCZZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCZZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCZZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCZZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisMaC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHSS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisMaC2V2MCWWHOS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisCenC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCZZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCZZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCZZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCZZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCZZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCZZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCZZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCZZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisCenC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWZHReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWZHReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWZH17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWZH17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWZH16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWZH16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWZH16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWZH16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHSS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        //std::string tmpStrWithPath = "/afs/crc.nd.edu/user/d/dlutton/Public/condorStuff/NanoAODToHistos/nanoAODAnalysis/cpp/HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_0_0_0_1.root";
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOSReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOSReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS17ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS17Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS16ReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS16Reweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
        ...
        //XS = ;
        isBackground = false;
        std::string tmpStrWithPath = "./HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS16APVReweightTrimmed"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        //std::string tmpStrWithPath = strAdd+"HLTTrimmedFilteredForAnalysisCenC2V2MCWWHOS16APVReweight"+NoSLString+"_WithJERRoch_"+std::to_string(JECCorInd)+"_"+std::to_string(JECCorUpOrDown)+"_"+std::to_string(RochInd)+"_"+std::to_string(JERInd)+".root";
        fileAr.push_back(tmpStrWithPath);
    }
    else if (testRun){
        saveName = "testRun";
    ...
    for (UInt_t k=0; k<fileAr.size(); k++){
        ...
        while (myEventsReader.Next()) {
            ...
            for (UInt_t nFatJetItr=0; nFatJetItr<nFatJetL;nFatJetItr++){
                ...
                FatJet_particleNet_mass_JMSUpJMRNomCorL.push_back(FatJet_particleNet_mass_JMSUpJMRNomCor[nFatJetItr]);
                FatJet_particleNet_mass_JMSDownJMRNomCorL.push_back(FatJet_particleNet_mass_JMSDownJMRNomCor[nFatJetItr]);
                FatJet_particleNet_mass_JMSNomJMRUpCorL.push_back(FatJet_particleNet_mass_JMSNomJMRUpCor[nFatJetItr]);
                FatJet_particleNet_mass_JMSNomJMRDownCorL.push_back(FatJet_particleNet_mass_JMSNomJMRDownCor[nFatJetItr]);
