...
void new062022SemiLepCutsFoMAnalysis(string inputString){
    ...
    */
    if (cutString == "fatJetZParticleNet") {
        cutRangeBottom = fatJetZParticleNetRangeBottom;
        cutStep = fatJetZParticleNetCutStep;
        cutPtr = &fatJetZParticleNetCut;
    };
