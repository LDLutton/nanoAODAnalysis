...
//Script for running over background MC using MD PN for selection and having the H AK8 selected before the Z AK8 jet
void new10162023BDTAnalysisBackground(string datasetString,string yearString){
    ...
    std::string outFileStr = "new10162023BDTAnalysis"+saveName+".root";
