...
void DoTrimmed042024HLTFilter2016OnBackground(int fileInd, string datasetString,uint yearInd){
    ...
    if (yearInd == 2) {
        if (ttHToBBBackground){
            ...
            */
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT50to100Y16BackgroundAr)/sizeof(QCDHT50to100Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT50to100Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT50to100Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT100to200Y16BackgroundAr)/sizeof(QCDHT100to200Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT100to200Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT100to200Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT200to300Y16BackgroundAr)/sizeof(QCDHT200to300Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT200to300Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT200to300Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT300to500Y16BackgroundAr)/sizeof(QCDHT300to500Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT300to500Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT300to500Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT500to700Y16BackgroundAr)/sizeof(QCDHT500to700Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT500to700Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT500to700Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT700to1000Y16BackgroundAr)/sizeof(QCDHT700to1000Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT700to1000Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT700to1000Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT1000to1500Y16BackgroundAr)/sizeof(QCDHT1000to1500Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT1000to1500Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT1000to1500Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT1500to2000Y16BackgroundAr)/sizeof(QCDHT1500to2000Y16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT1500to2000Y16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT1500to2000Y16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT2000toInfY16BackgroundAr)/sizeof(QCDHT2000toInfY16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT2000toInfY16BackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT2000toInfY16BackgroundAr[fileInd]);
        }
            ...
            */
            ...
            isBackground = true;
            int arrSize = sizeof(TTJetsHadronicY16BackgroundAr)/sizeof(TTJetsHadronicY16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJetsHadronicY16BackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJetsHadronicY16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(TTJetsSemiLeptonicY16BackgroundAr)/sizeof(TTJetsSemiLeptonicY16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJetsSemiLeptonicY16BackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJetsSemiLeptonicY16BackgroundAr[fileInd]);
        }
            ...
            isBackground = true;
            int arrSize = sizeof(TTJets2L2NuY16BackgroundAr)/sizeof(TTJets2L2NuY16BackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJets2L2NuY16BackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJets2L2NuY16BackgroundAr[fileInd]);
        }
            ...
            */
            ...
            int arrSize = sizeof(ZH_HToBB_ZToBBY16BackgroundAr)/sizeof(ZH_HToBB_ZToBBY16BackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToBBY16BackgroundAr[fileInd]);
        }
        else if (ZH_HToBB_ZToNuNuBackground){
            //datasetType = 66;
            saveName = "ZH_HToBB_ZToNuNu";
            
            int arrSize = sizeof(ZH_HToBB_ZToNuNuY16BackgroundAr)/sizeof(ZH_HToBB_ZToNuNuY16BackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToNuNuY16BackgroundAr[fileInd]);
        }
            ...
            int arrSize = sizeof(ggZH_HToBB_ZToBBY16BackgroundAr)/sizeof(ggZH_HToBB_ZToBBY16BackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToBBY16BackgroundAr[fileInd]);
        }
        else if (ggZH_HToBB_ZToNuNuBackground){
            //datasetType = 68;
            saveName = "ggZH_HToBB_ZToNuNu";
            
            int arrSize = sizeof(ggZH_HToBB_ZToNuNuY16BackgroundAr)/sizeof(ggZH_HToBB_ZToNuNuY16BackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToNuNuY16BackgroundAr[fileInd]);
        }
        ...
        if (ttHToBBBackground){
            ...
            */
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT50to100Y16APVBackgroundAr)/sizeof(QCDHT50to100Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT50to100Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT50to100Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT100to200Background){
            //saveName = "QCDHT100to200";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT100to200Y16APVBackgroundAr)/sizeof(QCDHT100to200Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT100to200Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT100to200Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT200to300Background){
            //saveName = "QCDHT200to300";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT200to300Y16APVBackgroundAr)/sizeof(QCDHT200to300Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT200to300Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT200to300Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT300to500Background){
            //saveName = "QCDHT300to500";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT300to500Y16APVBackgroundAr)/sizeof(QCDHT300to500Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT300to500Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT300to500Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT500to700Background){
            //saveName = "QCDHT500to700";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT500to700Y16APVBackgroundAr)/sizeof(QCDHT500to700Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT500to700Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT500to700Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT700to1000Background){
            //saveName = "QCDHT700to1000";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT700to1000Y16APVBackgroundAr)/sizeof(QCDHT700to1000Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT700to1000Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT700to1000Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT1000to1500Background){
            //saveName = "QCDHT1000to1500";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT1000to1500Y16APVBackgroundAr)/sizeof(QCDHT1000to1500Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT1000to1500Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT1000to1500Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT1500to2000Background){
            //saveName = "QCDHT1500to2000";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT1500to2000Y16APVBackgroundAr)/sizeof(QCDHT1500to2000Y16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT1500to2000Y16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT1500to2000Y16APVBackgroundAr[fileInd]);
        }
        else if (QCDHT2000toInfBackground){
            //saveName = "QCDHT2000toInf";
            ...
            isBackground = true;
            int arrSize = sizeof(QCDHT2000toInfY16APVBackgroundAr)/sizeof(QCDHT2000toInfY16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(QCDHT2000toInfY16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(QCDHT2000toInfY16APVBackgroundAr[fileInd]);
        }
        else if (TTJetsBackground){
            //saveName = "";
            ...
            */
            ...
            isBackground = true;
            int arrSize = sizeof(TTJetsHadronicY16APVBackgroundAr)/sizeof(TTJetsHadronicY16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJetsHadronicY16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJetsHadronicY16APVBackgroundAr[fileInd]);
        }
        else if (TTToSemiLeptonicBackground){
            //saveName = "";
            ...
            isBackground = true;
            int arrSize = sizeof(TTJetsSemiLeptonicY16APVBackgroundAr)/sizeof(TTJetsSemiLeptonicY16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJetsSemiLeptonicY16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJetsSemiLeptonicY16APVBackgroundAr[fileInd]);
        }
        else if (TTTo2L2NuBackground){
            //saveName = "";
            ...
            isBackground = true;
            int arrSize = sizeof(TTJets2L2NuY16APVBackgroundAr)/sizeof(TTJets2L2NuY16APVBackgroundAr[0]);
            /*
            for (int i=0; i<arrSize; i++){
                fileAr.push_back(TTJets2L2NuY16APVBackgroundAr[i]);
            }
            */
            fileAr.push_back(TTJets2L2NuY16APVBackgroundAr[fileInd]);
        }
        else if (ST_s_ChannelBackground){
            //saveName = "";
            ...
            */
            ...
            int arrSize = sizeof(ZH_HToBB_ZToBBY16APVBackgroundAr)/sizeof(ZH_HToBB_ZToBBY16APVBackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToBBY16APVBackgroundAr[fileInd]);
        }
        else if (ZH_HToBB_ZToNuNuBackground){
            //datasetType = 66;
            saveName = "ZH_HToBB_ZToNuNu";
            
            int arrSize = sizeof(ZH_HToBB_ZToNuNuY16APVBackgroundAr)/sizeof(ZH_HToBB_ZToNuNuY16APVBackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToNuNuY16APVBackgroundAr[fileInd]);
        }
        else if (ZH_HToBB_ZToLLBackground){
            //datasetType = 66;
            saveName = "ZH_HToBB_ZToLL";
            
            int arrSize = sizeof(ZH_HToBB_ZToLLY16APVBackgroundAr)/sizeof(ZH_HToBB_ZToLLY16APVBackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToLLY16APVBackgroundAr[fileInd]);
        }
        else if (ZH_HToBB_ZToQQBackground){
            //datasetType = 67;
            saveName = "ZH_HToBB_ZToQQ";
            
            int arrSize = sizeof(ZH_HToBB_ZToQQY16APVBackgroundAr)/sizeof(ZH_HToBB_ZToQQY16APVBackgroundAr[0]);
            fileAr.push_back(ZH_HToBB_ZToQQY16APVBackgroundAr[fileInd]);
        }
        else if (ggZH_HToBB_ZToBBBackground){
            //datasetType = 68;
            saveName = "ggZH_HToBB_ZToBB";
            
            int arrSize = sizeof(ggZH_HToBB_ZToBBY16APVBackgroundAr)/sizeof(ggZH_HToBB_ZToBBY16APVBackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToBBY16APVBackgroundAr[fileInd]);
        }
        else if (ggZH_HToBB_ZToNuNuBackground){
            //datasetType = 68;
            saveName = "ggZH_HToBB_ZToNuNu";
            
            int arrSize = sizeof(ggZH_HToBB_ZToNuNuY16APVBackgroundAr)/sizeof(ggZH_HToBB_ZToNuNuY16APVBackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToNuNuY16APVBackgroundAr[fileInd]);
        }
        else if (ggZH_HToBB_ZToLLBackground){
            //datasetType = 68;
            saveName = "ggZH_HToBB_ZToLL";
            
            int arrSize = sizeof(ggZH_HToBB_ZToLLY16APVBackgroundAr)/sizeof(ggZH_HToBB_ZToLLY16APVBackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToLLY16APVBackgroundAr[fileInd]);
        }
        else if (ggZH_HToBB_ZToQQBackground){
            //datasetType = 69;
            saveName = "ggZH_HToBB_ZToQQ";
            
            int arrSize = sizeof(ggZH_HToBB_ZToQQY16APVBackgroundAr)/sizeof(ggZH_HToBB_ZToQQY16APVBackgroundAr[0]);
            fileAr.push_back(ggZH_HToBB_ZToQQY16APVBackgroundAr[fileInd]);
        }
        else if (EWKZ2Jets_ZToLLBackground){
            //datasetType = 70;
            saveName = "EWKZ2Jets_ZToLL";
    ...
    if (yearInd == 2){
        saveName = saveName+"Y16";
    }
    else if (yearInd == 3) {
        saveName = saveName+"Y16APV";
    }
